...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // No need to manually store in localStorage or navigate
      // The ProtectedRoute will handle redirection to /home
  ...
  const handleForgotPassword = () => {
    ...
    alert("Password reset functionality - redirect to forgot password page");
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="left">
          ...
          <div className="footer">© 2024 Techfoliyo Inc. All rights reserved.</div>
        </div>
        ...
        <div className="right">
          <div className="card">
            ...
            <h2>Sign In</h2>
            <div className="subtitle">Access your portfolio and continue your journey.</div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="optionsRow">
                ...
                <span className="forgotLink" onClick={handleForgotPassword}>
                  Forgot password?
                </span>
              </div>
